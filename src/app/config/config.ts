export class CONFIG {
    ...
    public static api_wp_json =   "https://leggercolombia.com/wordpress/wp-json/wp/v2/" ;
    public static api_jwt_auth =   "https://leggercolombia.com/wordpress/wp-json/jwt-auth/v1/token" ;
